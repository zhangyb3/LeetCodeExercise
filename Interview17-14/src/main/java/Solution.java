...
class Solution {
    ...
    public int[] smallestK(int[] arr, int k) {
        ...
        //1、快排之后取前K
        //quickSortSolution( arr, 0,arr.length-1);
    ...
    private static void quickSortSolution(int[] arr, int left, int right) {
        ...
        //if(left < right){
            ...
            arr[i] = pivot;
            if(left < i-1){
                quickSortSolution(arr,left,i-1);
            }

            if(i+1 < right){
                quickSortSolution(arr,i+1,right);
            }
